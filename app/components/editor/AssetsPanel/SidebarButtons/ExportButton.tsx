    ...
    return (
        ...
        >
            ...
            <Image
                ...
                height={20}
                width={20}
                src="https://www.svgrepo.com/show/13682/upload.svg"
                style={{ filter: 'invert(1)' }}
            />
            <span className="text-[10px] text-textSecondary group-hover:text-textPrimary transition-colors relative z-10">Export</span>
        </button>
    );
}